                ...
                return (
                    <View key={idx+'eqqw'} style={{ height: 80, justifyContent: 'center', paddingLeft: 20 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Image source={pendingGame.photo_url.length ? { uri: pendingGame.photo_url } : require('../../assets/images/profilePicture.png')} style={{ height: 35, width: 35, borderRadius: 5, marginRight: 15 }} />
                            <View style={{ flex: 0.3 }}>
