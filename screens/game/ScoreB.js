...
export default class ScoreB extends React.Component {
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1, padding: 50, alignItems: 'center' }}>
                    ...
                    <FontAwesome name={'check'} style={{marginBottom: 15}} size={180} color={'#3A8FFF'} />

                    <Text style={{fontSize: 22, textAlign: 'center', color: '#333'}}>We have been notified of the dispute and we will be in touch through email.</Text>
                    ...
                    <View style={{height: 20 }}>
                        <Text style={{textAlign: 'center'}}>Note that the amount placed on this match will be frozen until we sort out the dispute.</Text>
                    </View>
